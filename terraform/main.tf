...
module "sandbox2" {
  ...
  change_management_parameters = {
    change_requested_by = "HashiCorp Learn"
    change_reason       = "Learn AWS Control Tower Accouxxxnt Factory for Terraform"
  }
...
module "sandbox3" {
  ...
  control_tower_parameters = {
    AccountEmail              = "jcheng+dev3+sandbox3@natera.com"
    AccountName               = "sandbox-aft"
    ManagedOrganizationalUnit = "Learn AFT"
    SSOUserEmail              = "jcheng+dev3+sandbox3@natera.com"
    SSOUserFirstName          = "Sandbox"
    SSOUserLastName           = "AFT"
  }
